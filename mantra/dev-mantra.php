...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query_one = "SELECT MAX(id) + 1 AS next_id FROM mantra_data";
...
$base_link = str_replace(' ', '-', $base_link); 
    ...
    $check_sql = "SELECT id, link FROM mantra_data WHERE link LIKE '$base_link%'";
    $check_result = $conn->query($check_sql);

    if ($check_result->num_rows > 0) {
        // If link exists, get the highest ID
        $latest_id_sql = "SELECT MAX(id) AS latest_id FROM mantra_data";
    ...
    $sql = "INSERT INTO mantra_data (title_txt, content_txt, link) 
...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Discover powerful {$ques_text} on HinduIntellectual. Chant these sacred hymns {$ques_text}, invoke blessings, and experience spiritual tranquility.">
    <meta name="keywords" content="{$ques_text}, {$ques_text} Lyrics, Hindu Prayers, Spiritual Hymns, {$ques_text} Devotion, Divine Blessings, {$ques_text} Meditation">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://www.hinduintellectual.com/mantra/{$newFileName}">
    <meta property="og:title" content="{$ques_text}">
    <meta property="og:description" content="Explore {$ques_text} and chants to invoke the divine energy. Embrace blessings and attain peace and enlightenment.">
    <meta property="og:image" content="https://www.hinduintellectual.com/mantra/resource/{$next_id}.png">
    <meta property="og:url" content="https://www.hinduintellectual.com/mantra/{$newFileName}">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{$ques_text}">
    <meta name="twitter:description" content="Chant powerful {$ques_text} to connect width divine energy. Experience divine blessings, peace, and spiritual enlightenment with these sacred hymns.">
    <meta name="twitter:image" content="https://www.hinduintellectual.com/mantra/resource/{$next_id}.png">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "CreativeWork",
      "name": "{$ques_text}",
      "url": "https://www.hinduintellectual.com/mantra/{$newFileName}",
      "description": "Discover {$ques_text}, sacred chants. Embrace spiritual peace, divine blessings, and meditative tranquility through these powerful hymns.",
      "author": {
        "@type": "Organization",
      ...
      "mainEntityOfPage": "https://www.hinduintellectual.com/mantra/{$newFileName}",
      "image": "https://www.hinduintellectual.com/mantra/resource/{$next_id}.png"
    }
    </script>
</head>
<body>
...
?>
    ...
    <div class="question_feed">
        ...
        \$sql = "SELECT * FROM mantra_data ORDER BY id DESC LIMIT 5";
...
<!-- Section to display 8 random questions -->
        ...
        // SQL query to retrieve 8 random entries
        \$sql = "SELECT * FROM mantra_data ORDER BY RAND() LIMIT 8";
