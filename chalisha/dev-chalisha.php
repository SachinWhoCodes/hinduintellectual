...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query_one = "SELECT MAX(id) + 1 AS next_id FROM chalisha_data";
...
$base_link = str_replace(' ', '-', $base_link); 
    ...
    $check_sql = "SELECT id, link FROM chalisha_data WHERE link LIKE '$base_link%'";
    $check_result = $conn->query($check_sql);

    if ($check_result->num_rows > 0) {
        // If link exists, get the highest ID
        $latest_id_sql = "SELECT MAX(id) AS latest_id FROM chalisha_data";
    ...
    $sql = "INSERT INTO chalisha_data (title_txt, content_txt, link) 
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Discover the {$ques_text} on HinduIntellectual. Learn the powerful hymn of {$ques_text}, its meaning, benefits, and how it can bring blessings into your life.">
    <meta name="keywords" content="{$ques_text}, Lord {$ques_text}, {$ques_text} Stotra, Powerful Hymn, {$ques_text} Mantra, {$ques_text} Prayer, Spiritual Hymns, Hindu Devotion, Hindu Prayers">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://www.hinduintellectual.com/chalisha/{$newFileName}">
    <meta property="og:title" content="{$ques_text}: Chant the Powerful Hymn {$ques_text}">
    <meta property="og:description" content="Recite the {$ques_text} to invoke blessings from {$ques_text}. Learn the hymn's meaning, benefits, and how it connects with the divine energy.">
    <meta property="og:image" content="https://www.hinduintellectual.com/chalisha/resource/{$next_id}.png">
    <meta property="og:url" content="https://www.hinduintellectual.com/chalisha/{$newFileName}">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{$ques_text}: Chant the Powerful Hymn {$ques_text}">
    <meta name="twitter:description" content="Recite the powerful {$ques_text} to connect with devine energy. Learn about its meanings, spiritual benefits, and how it can transform your life.">
    <meta name="twitter:image" content="https://www.hinduintellectual.com/chalisha/resource/{$next_id}.png">
    <title>{$ques_text} Hindi Lyrics : Chant the Powerful {$ques_text} | HinduIntellectual</title>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "CreativeWork",
      "name": "{$ques_text}",
      "url": "https://www.hinduintellectual.com/chalisha/{$newFileName}",
      "description": "Recite the {$ques_text}, a powerful hymn. Learn about its benefits, meanings, and how it enhances spiritual connection.",
      "author": {
        "@type": "Organization",
      ...
      "mainEntityOfPage": "https://www.hinduintellectual.com/chalisha/{$newFileName}",
      "image": "https://www.hinduintellectual.com/chalisha/resource/{$next_id}.png"
    }
    </script>
</head>
<body>
...
?>
    ...
    <div class="question_feed">
        ...
        \$sql = "SELECT * FROM chalisha_data ORDER BY id DESC LIMIT 5";
...
<!-- Section to display 8 random questions -->
        ...
        // SQL query to retrieve 8 random entries
        \$sql = "SELECT * FROM chalisha_data ORDER BY RAND() LIMIT 8";
