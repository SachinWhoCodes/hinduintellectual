    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/23.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Shiv Maha Puran</h2>
                <p class="desc_of_book laila-medium">The Shiva Purana is one of the eighteen major Puranas in Hinduism, dedicated to Lord Shiva. It describes the creation of the universe, the genealogy of gods, and the importance of worshipping Shiva. The text contains stories of Shiva’s various forms, his cosmic role, and his interactions with other deities and sages. It emphasizes devotion, rituals, and the pursuit of spiritual knowledge, guiding followers toward liberation. The Shiva Purana is a significant scripture in Shaivism, offering insights into the nature of the divine and the path to salvation.<br>शिव पुराण हिंदू धर्म के अठारह प्रमुख पुराणों में से एक है, जो भगवान शिव को समर्पित है। यह ब्रह्मांड की रचना, देवताओं की उत्पत्ति और शिव की पूजा के महत्व का वर्णन करता है। इसमें शिव के विभिन्न रूपों, उनके ब्रह्मांडीय कर्तव्यों और देवताओं और ऋषियों के साथ उनकी अंतःक्रियाओं की कथाएँ शामिल हैं। यह भक्ति, अनुष्ठान और आध्यात्मिक ज्ञान की प्राप्ति पर बल देता है, जो अनुयायियों को मोक्ष की ओर मार्गदर्शन करता है। शिव पुराण शैव परंपरा में एक महत्वपूर्ण ग्रंथ है, जो दिव्य स्वरूप और मुक्ति के मार्ग को समझने में सहायक है।</p>
