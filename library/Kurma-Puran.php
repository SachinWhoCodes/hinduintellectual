    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/17.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Kurma Puran</h2>
                <p class="desc_of_book laila-medium">The Kurma Purana is one of Hinduism\'s eighteen major Puranas, narrated by Lord Vishnu in his Kurma (tortoise) incarnation. It discusses cosmology, the creation of the universe, and the importance of dharma. The text highlights spiritual knowledge, rituals, and devotion while recounting stories of deities like Shiva and Vishnu. It serves as a guide to moral living and achieving liberation.<br>कूर्म पुराण हिंदू धर्म के अठारह प्रमुख पुराणों में से एक है, जिसे भगवान विष्णु ने अपने कूर्म (कछुए) अवतार में बताया था। इसमें ब्रह्मांड रचना, धर्म का महत्व और आध्यात्मिक ज्ञान पर चर्चा की गई है। यह ग्रंथ अनुष्ठानों, भक्ति और शिव-विष्णु की कथाओं को प्रस्तुत करता है। यह धर्मपूर्ण जीवन और मोक्ष प्राप्ति का मार्गदर्शन करता है।</p>
