    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/12.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Shrimad Bhagwat Maha Puran</h2>
                <p class="desc_of_book laila-medium">Shrimad Bhagavata Mahapurana, often referred to as the Bhagavata Purana, is a sacred scripture of Hinduism dedicated to Lord Vishnu and his various avatars, especially Lord Krishna. It consists of 12 cantos and highlights the path of devotion (bhakti) as a means to attain liberation (moksha). The text narrates enchanting stories of Krishna’s divine pastimes, cosmic creation, and teachings of dharma. It emphasizes love, righteousness, and surrender to God, offering spiritual wisdom and practical guidance for a virtuous life. <br>श्रीमद् भागवत महापुराण, जिसे भागवत पुराण भी कहा जाता है, हिंदू धर्म का एक पवित्र ग्रंथ है जो भगवान विष्णु और उनके विभिन्न अवतारों, विशेष रूप से श्रीकृष्ण को समर्पित है। यह 12 स्कंधों में विभाजित है और भक्ति को मोक्ष प्राप्ति का साधन बताता है। इसमें श्रीकृष्ण की दिव्य लीलाओं, सृष्टि की रचना और धर्म के उपदेशों की कथाएँ सम्मिलित हैं। यह ग्रंथ प्रेम, धर्म और भगवान के प्रति समर्पण पर जोर देता है और आध्यात्मिक ज्ञान के साथ-साथ धर्मपूर्ण जीवन जीने की प्रेरणा प्रदान करता है।</p>
