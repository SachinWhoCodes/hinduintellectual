    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/28.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Vishnu Puran</h2>
                <p class="desc_of_book laila-medium">The Vishnu Purana is one of the eighteen major Puranas in Hinduism, dedicated to Lord Vishnu, the preserver of the universe. It covers a wide range of topics, including the creation of the cosmos, the genealogies of gods, and the importance of dharma. The text also contains stories of Vishnu’s incarnations, including those of Rama and Krishna, illustrating his role in restoring cosmic order. The Vishnu Purana emphasizes devotion, righteousness, and the pursuit of liberation, providing guidance on worship, rituals, and ethical living.<br>विष्णु पुराण हिंदू धर्म के अठारह प्रमुख पुराणों में से एक है, जो भगवान विष्णु, जो ब्रह्मांड के पालनहार हैं, को समर्पित है। यह ब्रह्मांड की रचना, देवताओं की उत्पत्ति और धर्म के महत्व पर विस्तृत रूप से चर्चा करता है। इसमें भगवान विष्णु के अवतारों, जैसे राम और कृष्ण की कथाएँ भी हैं, जो ब्रह्मांडीय व्यवस्था को पुनर्स्थापित करने में उनके योगदान को दर्शाती हैं। विष्णु पुराण भक्ति, धर्म और मोक्ष की प्राप्ति पर बल देता है, और पूजा, अनुष्ठान और नैतिक जीवन जीने के लिए मार्गदर्शन प्रदान करता है।</p>
