...
?>
    ...
    <div class="book_box">
        <div class="book_box_space">
            ...
            <div class="book_box_right">
                ...
                <h2 class="laila-bold">Agni Puran (अग्नि पुराण) </h2>
                <p class="desc_of_book laila-medium">The Agni Purana is one of the major Puranas in Hinduism, dedicated to Lord Agni, the god of fire. It comprises a wide range of topics, including cosmology, rituals, temple construction, and dharma. The text provides knowledge about ancient sciences, Vedic practices, and stories that inspire spiritual growth.<br>अग्नि पुराण हिंदू धर्म के प्रमुख पुराणों में से एक है, जो अग्नि देव को समर्पित है। इसमें ब्रह्मांड विज्ञान, अनुष्ठान, मंदिर निर्माण और धर्म से जुड़े विभिन्न विषय शामिल हैं। यह प्राचीन विज्ञान, वैदिक परंपराओं और आध्यात्मिक विकास को प्रेरित करने वाली कथाओं का संग्रह प्रस्तुत करता है।</p>
    ...
    <!--    </div>-->
    <!--    <iframe class="pdf_read_screen" src='https://drive.google.com/file/d/1ZUw_4DG_-hbLnRb5j6he4qh0GZkgoYXe/view?usp=sharing'></iframe>-->
    <!--</div>-->
