    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/14.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Brahma Puran</h2>
                <p class="desc_of_book laila-medium">The Brahma Purana is one of Hinduism\'s eighteen major Puranas, dedicated to Lord Brahma. It explores the creation of the universe, sacred sites, and dharma. This text highlights rituals, devotion, and legends of deities like Vishnu, Shiva, and Surya. Known as the Adipurana, it emphasizes morality and liberation, offering essential teachings for spiritual growth and righteous living.<br>ब्रह्म पुराण हिंदू धर्म के अठारह प्रमुख पुराणों में से एक है, जो भगवान ब्रह्मा को समर्पित है। इसमें ब्रह्मांड की उत्पत्ति, पवित्र स्थलों और धर्म का वर्णन है। यह विष्णु, शिव और सूर्य की कथाओं, भक्ति और मोक्ष पर जोर देता है। आदिपुराण के रूप में प्रसिद्ध यह ग्रंथ आध्यात्मिक उन्नति का मार्ग दिखाता है।</p>
