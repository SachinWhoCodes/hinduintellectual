    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/20.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Matsya Puran</h2>
                <p class="desc_of_book laila-medium">The Matsya Purana is one of Hinduism\'s eighteen major Puranas, primarily focusing on the story of Lord Vishnu\'s Matsya (fish) incarnation. It narrates the tale of Vishnu saving the ancient scriptures and sages from a great deluge, symbolizing the preservation of knowledge. The text also covers cosmology, creation, rituals, and moral teachings. It is an important scripture in Hindu tradition, emphasizing the importance of dharma, devotion, and the role of divine intervention in preserving order.<br>मात्स्य पुराण हिंदू धर्म के अठारह प्रमुख पुराणों में से एक है, जो भगवान विष्णु के मात्स्य (मछली) अवतार की कथा पर आधारित है। इसमें विष्णु द्वारा प्रलय के समय प्राचीन वेदों और ऋषियों की रक्षा करने की कथा है, जो ज्ञान के संरक्षण का प्रतीक है। यह ग्रंथ ब्रह्मांड की रचना, अनुष्ठान और नैतिक शिक्षाओं पर भी चर्चा करता है। यह हिंदू परंपरा में महत्वपूर्ण ग्रंथ है, जो धर्म, भक्ति और ईश्वर की भूमिका पर प्रकाश डालता है।</p>
