    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/22.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Padma Puran</h2>
                <p class="desc_of_book laila-medium">The Padma Purana is one of the eighteen major Puranas in Hinduism, known for its detailed descriptions of the creation of the universe, cosmology, and the importance of worshipping various deities, particularly Lord Vishnu. It is divided into five sections and includes stories of gods, sages, and kings, highlighting the significance of dharma, rituals, and devotion. The Padma Purana also emphasizes the power of sacred places and the importance of pilgrimage in attaining spiritual liberation.<br>पद्म पुराण हिंदू धर्म के अठारह प्रमुख पुराणों में से एक है, जो ब्रह्मांड की रचना, ब्रह्मांड विज्ञान और विशेष रूप से भगवान विष्णु की पूजा के महत्व का विस्तृत वर्णन करता है। यह पांच खंडों में विभाजित है और देवताओं, ऋषियों और राजाओं की कथाओं को प्रस्तुत करता है, जो धर्म, अनुष्ठानों और भक्ति के महत्व को रेखांकित करते हैं। पद्म पुराण पवित्र स्थलों की शक्ति और मोक्ष प्राप्ति के लिए तीर्थ यात्रा के महत्व पर भी बल देता है।</p>
