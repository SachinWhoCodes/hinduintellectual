    ...
    <div class="book_box">
        <div class="book_box_space">
            <div class="book_box_left">
                <img src="resource/18.png" alt="">
            </div>
            <div class="book_box_right">
                <p class="laila-lite cate_txt">Puran</p>
                <h2 class="laila-bold">Ling Puran</h2>
                <p class="desc_of_book laila-medium">The Linga Purana is one of Hinduism\'s eighteen major Puranas, centered on Lord Shiva and the symbolic significance of the Shiva Linga. It explains the creation of the universe, the cycles of time, and the importance of devotion and rituals dedicated to Shiva. The text also includes spiritual teachings and stories that emphasize dharma and liberation, making it a vital scripture for Shaivism.<br>लिंग पुराण हिंदू धर्म के अठारह प्रमुख पुराणों में से एक है, जो भगवान शिव और शिवलिंग के प्रतीकात्मक महत्व पर केंद्रित है। इसमें ब्रह्मांड की उत्पत्ति, समय चक्र, और शिव को समर्पित भक्ति और अनुष्ठानों का महत्व बताया गया है। यह धर्म और मोक्ष पर आधारित शिक्षाओं और कहानियों को प्रस्तुत करता है, जो शैव परंपरा में महत्वपूर्ण स्थान रखता है।</p>
