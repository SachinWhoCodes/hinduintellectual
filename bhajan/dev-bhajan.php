...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query_one = "SELECT MAX(id) + 1 AS next_id FROM bhajan_data";
...
$base_link = str_replace(' ', '-', $base_link); 
    ...
    $check_sql = "SELECT id, link FROM bhajan_data WHERE link LIKE '$base_link%'";
    $check_result = $conn->query($check_sql);

    if ($check_result->num_rows > 0) {
        // If link exists, get the highest ID
        $latest_id_sql = "SELECT MAX(id) AS latest_id FROM bhajan_data";
    ...
    $sql = "INSERT INTO bhajan_data (title_txt, content_txt, link) 
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Explore {$ques_text} on HinduIntellectual. Devote yourself with melodious hymns {$ques_text} that invoke wisdom, knowledge, and spiritual enlightenment.">
    <meta name="keywords" content="{$ques_text}, {$ques_text} Lyrics, {$ques_text} Lyrics in Hindi, {$ques_text} Lyrics Hindi, Hindu Bhajans, {$ques_text} Songs, Spiritual Hymns, {$ques_text} Prayer, Hindu Devotion, Divine Wisdom, Hindu Prayers">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://www.hinduintellectual.com/bhajan/{$newFileName}">
    <meta property="og:title" content="{$ques_text}">
    <meta property="og:description" content="Immerse yourself in {$ques_text}. These devotional songs inspire wisdom, creativity, and spiritual growth.">
    <meta property="og:image" content="https://www.hinduintellectual.com/bhajan/resource/{$next_id}.png">
    <meta property="og:url" content="https://www.hinduintellectual.com/bhajan/{$newFileName}">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{$ques_text}">
    <meta name="twitter:description" content="Explore the spiritual world of {$ques_text} and connect with the divine energy through these soulful hymns.">
    <meta name="twitter:image" content="https://www.hinduintellectual.com/bhajan/resource/{$next_id}.png">
    <title>{$ques_text} | Hindu Intellectual</title>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "CreativeWork",
      "name": "{$ques_text}",
      "url": "https://www.hinduintellectual.com/bhajan/{$newFileName}",
      "description": "Immerse yourself in {$ques_text}, devotional hymns. These bhajans inspire wisdom, creativity, and spiritual enlightenment.",
      "author": {
        "@type": "Organization",
      ...
      "mainEntityOfPage": "https://www.hinduintellectual.com/bhajan/{$newFileName}",
      "image": "https://www.hinduintellectual.com/bhajan/resource/{$next_id}.png"
    }
    </script>
</head>
<body>
