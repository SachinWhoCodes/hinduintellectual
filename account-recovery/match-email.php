...
<head>
    ...
    <title>Match Email - Hindu Intellectual</title>
...
<div class="login_box">
    <div class="login_space">
        <div class="login_heading">
            <h1 class="laila-bold" >Enter Your Email</h1>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $entered_email = $_POST['mail']; // Email entered in the form
    ...
    if (!empty($phone) && !empty($entered_email)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($entered_email === $stored_email) {
                echo "<p>Email matches the linked account.</p>";
                $_SESSION['recoStat'] = 2;
                echo '<script>window.location.href = "https://hinduintellectual.com/account-recovery/verify-email.php?phone='.$phone.'&email='.$entered_email.'";</script>';
            } else {
                echo "<p>This email is not linked to ".$phone."</p>";
            }
        } else {
            echo "<p>No account found for the provided phone number.</p>";
            echo '<script>window.location.href = "https://hinduintellectual.com/account-recovery/find-account.php";</script>';
        }
    } else {
...
?>
        ...
        <form class="main_login_form" action="" method="post" >
            <div class="input_box">
                ...
                <input name="mail" class="laila-regular" type="text" placeholder="Email Linked To Your Account">
            </div>
